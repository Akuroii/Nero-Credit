    ...
    <PointerFieldProvider>
      <EnergyProvider>
        <div className="relative min-h-screen w-full">
          ...
          <div className="relative mx-auto h-[980px] w-full max-w-[1150px] sm:h-[900px]">
            <div
              className="absolute left-1/2"
              style={{ top: isMobile ? '2%' : '1.5%', transform: 'translateX(-50%)' }}
            >
              <NeroCore size={isMobile ? 128 : 172} onActivate={() => setMenuOpen((v) => !v)} />
            </div>
